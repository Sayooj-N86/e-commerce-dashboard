...
const BannersEdit = ({banner,bannerId,category}:props) => {
  console.log("ewewee",category)
    ...
    const submitData = async (data:any)=>{
      try{
        const response = await bannerApi.updateBanner(data ,bannerId);
  ...
  return (
    <>
      <Breadcrumb pageName="Banner Edit" />
